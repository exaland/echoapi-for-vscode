...
function getPropertyFormat(value: any) {
...
function getUniqueKeys(a: any, b: any, c: any) {
  a = Object.keys(a);
  b = Object.keys(b);
  c = c || [];
...
function processArray(array: any, output?: any, nested?: any) {
  let format;
  let oneOf;
  let type;
...
function processObject(object: any, output?: any, nested?: any) {
  if (nested && output) {
...
export default function Process(title: any, object?: any) {
  let processOutput;
  const output: any = {
  };
