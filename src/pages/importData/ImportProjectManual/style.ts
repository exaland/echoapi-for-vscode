...
export const ImportProjectManualWrap = styled.div<{ $token: Partial<GlobalThemeToken> }>`
  .import-project-item {
    margin-top: 16px;
...
padding: 16px;
  ...
  .import-project-upload-content {
    ...
    .beautify-upload-list-item-container .beautify-upload-list-item .apipost-upload-list-item-name{
      font-size: 12px;
    }
    .beautify-upload{
      margin-bottom: 20px;
