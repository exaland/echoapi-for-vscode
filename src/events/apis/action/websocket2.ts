...
export const cloneWebsocket = (params: ApisItemActionType) => {
...
export const deleteWebsocket = (params: ApisItemActionType) => {
  const { apisData } = params;
  window?.vscode.postMessage({
...
export const editWebsocket = (params: ApisItemActionType) => {
...
export default {
  clone: cloneWebsocket,
  delete: deleteWebsocket,
  edit:editWebsocket,
